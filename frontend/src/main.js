...
// 1. Firebase Auth サーバーとの接続を確立
// 2. ブラウザの認証状態（localStorage、sessionStorage など）をチェック。
// 3. 認証状態が確認できた時点で onAuthStateChanged コールバックを自動実行
